...
var _parentCall_debug;
var _startFunction;
var _ready = true;	// assume ready as soon as registration is called, unless otherwise specified.  Hmm, not sure.
var _frameId;

function slideSetStartFunction(startFunction, isLoading)
{
	if (isLoading == null)
	{
		isLoading = false;
	...
	_ready = !isLoading;
	if (typeof _parentCall_startFunction !== "undefined") _parentCall_startFunction(_frameId, startFunction, isLoading);
}		
...
function debug(text)
{
	if (typeof _parentCall_debug !== "undefined") _parentCall_debug(_frameId, text);
}
